...
def ETHEC_train_model(arguments):
    ...
    if not arguments.merged:
        train_set = ETHECDB(path_to_json='../database/ETHEC/formatted_train.json',
                            path_to_images=arguments.image_dir,
                            labelmap=labelmap, transform=train_data_transforms)
        val_set = ETHECDB(path_to_json='../database/ETHEC/formatted_val.json',
                          path_to_images=arguments.image_dir,
                          labelmap=labelmap, transform=val_test_data_transforms)
        test_set = ETHECDB(path_to_json='../database/ETHEC/formatted_test.json',
                           path_to_images=arguments.image_dir,
                           labelmap=labelmap, transform=val_test_data_transforms)
