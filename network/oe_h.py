...
def create_combined_graphs(dataloaders, labelmap):
    ...
    np.save('../database/neg_adjacency.npy', A)

    nx.write_gpickle(G, '../database/G')
    nx.write_gpickle(nx.transitive_closure(G), '../database/G_tc')
    nx.write_gpickle(G_train, '../database/G_train')
    nx.write_gpickle(G_val, '../database/G_val')
    nx.write_gpickle(G_test, '../database/G_test')
    nx.write_gpickle(G_train_skeleton_full, '../database/G_train_skeleton_full')
    nx.write_gpickle(G_train_tc, '../database/G_train_tc')
...
def load_combined_graphs(debug):
    ...
    G = nx.read_gpickle(os.path.join(path_to_folder, '../database/G'))
    G_tc = nx.read_gpickle(os.path.join(path_to_folder, '../database/G_tc'))
    G_train = nx.read_gpickle(os.path.join(path_to_folder, '../database/G_train'))
    G_val = nx.read_gpickle(os.path.join(path_to_folder, '../database/G_val'))
    G_test = nx.read_gpickle(os.path.join(path_to_folder, '../database/G_test'))
    G_train_skeleton_full = nx.read_gpickle(os.path.join(path_to_folder, '../database/G_train_skeleton_full'))
    G_train_tc = nx.read_gpickle(os.path.join(path_to_folder, '../database/G_train_tc'))
    G_train_neg = np.load(os.path.join(path_to_folder, '../database/neg_adjacency.npy'))
